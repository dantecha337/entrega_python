...
#Agarra todas las palabras de la categoria seleccionada en un orden aleatorio
palabras_mezcladas=random.sample(categorias[eleccion], len(categorias[eleccion]))
...
for word in palabras_mezcladas:
    ...
    print(f"Puntaje de ronda conseguido: {puntaje}")
    puntaje_total+=puntaje
    print()

print(f"Puntaje total conseguido: {puntaje_total}")